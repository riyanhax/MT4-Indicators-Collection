...
drawTrendline(r3,"R3", Sienna,0);
drawLabel("Resistance 3",r3,White);
drawTrendline(r2,"R2", Sienna,0);
drawLabel("Resistance 2",r2,White);
drawTrendline(r1,"R1", Sienna,0);
drawLabel("Resistance 1",r1,White);

drawTrendline(p,"PIVIOT",Goldenrod,1);
drawLabel("Piviot level",p,White);

drawTrendline(s1,"S1",Sienna,0);
drawLabel("Support 1",s1,White);
drawTrendline(s2,"S2",Sienna,0);
drawLabel("Support 2",s2,White);
drawTrendline(s3,"S3",Sienna,0);
drawLabel("Support 3",s3,White);
