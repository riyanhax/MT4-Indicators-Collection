...
string          SymList[21],                // Array containing authorized security pairs. 
               ...
               switch(Period())  // Phase 1 amplitude values for each time frame for security pairs other than JPY and MXN.
                 {
                  ...
                  case 43200: Ph1step=0.01;    Clearance=0.026;  break;
                 }
               break;
               ...
               switch(Period()) // Phase 1 amplitude values for each time frame of MXN paired securities.
                 {
                  ...
                  case 43200: Ph1step=0.1;    Clearance=0.26;  break;
                 }
               break;
               ...
               switch(Period()) // Phase 1 amplitude values for each time frame of JPY paired securities.
                 {
                  ...
                  case 43200: Ph1step=1.0;   Clearance=2.6;  break;
                 }
               break;
           }
        }
      ...
      if(Mode==2)
        {
         ...
         if(Close[c]<hpx1[c])
           {hpx0[c]=hpx1[c]-Ph1step;}
         b0=hpx0[c];b1=hpx0[c+1];r0=hpx1[c];r1=hpx1[c+1];
        } // Copy phase values to arrow and alert interface variables.
      ...
      if(Mode==0 || Mode==1)
        {
         ...
         b0=iMAX0[c];b1=iMAX0[c+1];r0=iMAX1[c];r1=iMAX1[c+1];
        } // Copy phase values to arrow and alert interface variables.
      ...
      if(Mode==1)
        {
         ...
         hp1[c]= xhp0;
         b0=hp0[c];b1=hp0[c+1];r0=hp1[c];r1=hp1[c+1];
        } // Copy phase values to arrow and alert interface variables.
